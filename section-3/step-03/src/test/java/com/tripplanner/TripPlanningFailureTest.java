        ...
        public static class ScriptedModel implements ChatModel {
            ...
            public ChatResponse doChat(ChatRequest request) {
                ...
                if (prompt.contains("vehicle specialist")) {
                    ...
                    json = """
                            {"type":"MPV","model":"Family MPV; specific model subject to availability.",
                             "reasoning":"Revised. Suggested category: MPV. Confirm seating, luggage capacity, price, and availability with the rental provider."}
                            """;
