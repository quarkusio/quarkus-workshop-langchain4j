# Step 06 - Using Remote Agents (A2A)

## New Requirement: Distributing the Pricing Service

In Steps 4 and 5, you implemented a complete disposition system with the Supervisor Pattern and Human-in-the-Loop approval. The system works well, but the Miles of Smiles management team has a new architectural requirement:
...
- **Completed [Step 05](step-05.md){target="_blank"}** - This step directly builds on Step 5's architecture
- Application from Step 05 is stopped (Ctrl+C)
- Ports 8080 and 8888 are available (you'll run two applications simultaneously)
- Understanding of Step 5's HITL Pattern and Step 4's Supervisor Pattern (we keep the same patterns, just make PricingAgent remote)

---

## Understanding the Project Structure

The Step 06 code includes **two separate Quarkus applications**:
...
!!! warning "Warning: this chapter involves many steps"
    ...
    we recommend starting fresh from Step 06 with the changes already applied.
...
=== "Option 2: Start Fresh from Step 06 [Recommended]"

    Navigate to the complete `section-2/step-06/multi-agent-system` directory:
    
    ```bash
    cd section-2/step-06/multi-agent-system
    ```
...
=== "Option 1: Continue from Step 05"
    ...
    === "Linux / macOS"
        ```bash
        cp ../step-06/multi-agent-system/pom.xml ./pom.xml
        cp ../step-06/multi-agent-system/src/main/java/com/carmanagement/model/CarInfo.java ./src/main/java/com/carmanagement/model/CarInfo.java
        cp ../step-06/multi-agent-system/src/main/java/com/carmanagement/model/CarStatus.java ./src/main/java/com/carmanagement/model/CarStatus.java
        cp ../step-06/multi-agent-system/src/main/resources/META-INF/resources/css/styles.css ./src/main/resources/META-INF/resources/css/styles.css
        cp ../step-06/multi-agent-system/src/main/resources/META-INF/resources/js/app.js ./src/main/resources/META-INF/resources/js/app.js
        cp ../step-06/multi-agent-system/src/main/resources/META-INF/resources/index.html ./src/main/resources/META-INF/resources/index.html
        cp ../step-06/multi-agent-system/src/main/resources/import.sql ./src/main/resources/import.sql
        ```
    
    === "Windows"
        ```cmd
        copy ..\step-06\multi-agent-system\pom.xml .\pom.xml
        copy ..\step-06\multi-agent-system\src\main\java\com\carmanagement\model\CarInfo.java .\src\main\java\com\carmanagement\model\CarInfo.java
        copy ..\step-06\multi-agent-system\src\main\java\com\carmanagement\model\CarStatus.java .\src\main\java\com\carmanagement\model\CarStatus.java
        copy ..\step-06\multi-agent-system\src\main\resources\META-INF\resources\css\styles.css .\src\main\resources\META-INF\resources\css\styles.css
        copy ..\step-06\multi-agent-system\src\main\resources\META-INF\resources\js\app.js .\src\main\resources\META-INF\resources\js\app.js
        copy ..\step-06\multi-agent-system\src\main\resources\META-INF\resources\index.html .\src\main\resources\META-INF\resources\index.html
        copy ..\step-06\multi-agent-system\src\main\resources\import.sql .\src\main\resources\import.sql
        ```
...
--8<-- "../../section-2/step-06/multi-agent-system/src/main/java/com/carmanagement/agentic/agents/PricingAgent.java"
```
...
```bash
cd section-2/step-06/remote-a2a-agent
```
...
```java title="PricingAgent.java"
--8<-- "../../section-2/step-06/remote-a2a-agent/src/main/java/com/demo/PricingAgent.java"
```
...
--8<-- "../../section-2/step-06/remote-a2a-agent/src/main/java/com/demo/PricingAgentCard.java"
```
...
--8<-- "../../section-2/step-06/remote-a2a-agent/src/main/java/com/demo/PricingAgentExecutor.java"
```
...
??? warning "Both applications on same port"
    ...
    - Make sure you stopped the application from Step 05
...
- **Step 6**: Distributed architecture with A2A protocol
