...
VALUES
    (nextval('car_info_id_seq'), 'Toyota', 'Corolla', 2020, 'Like new, no issues', CURRENT_DATE + INTERVAL '18 months', 'AT_CLEANING'),
    (nextval('car_info_id_seq'), 'Honda', 'Civic', 2024, 'Good condition, minor wear and tear', NULL, 'RENTED'),
    ...
    (nextval('car_info_id_seq'), 'Mercedes-Benz', 'C-Class', 2020, 'Minor dent on passenger door', CURRENT_DATE + INTERVAL '12 months', 'IN_MAINTENANCE'),
    ...
    (nextval('car_info_id_seq'), 'Audi', 'Q4', 2025, 'Brake pads recently replaced', NULL, 'RENTED');