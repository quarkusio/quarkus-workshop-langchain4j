...
INSERT INTO car_info (id, make, model, year, condition, status) VALUES (3, 'Ford', 'F-150', 2021, 'Small scratch on rear bumper', 'AT_CAR_WASH');
...
INSERT INTO car_info (id, make, model, year, condition, status) VALUES (11, 'Ford', 'Mustang', 2022, 'Needs oil change soon', 'AT_CAR_WASH');
