...
INSERT INTO car_info (id, make, model, year, condition, status) VALUES
    ...
    (nextval('car_info_id_seq'), 'Ford', 'F-150', 2021, 'Small scratch on rear bumper', 'AT_CAR_WASH'),
    (nextval('car_info_id_seq'), 'Chevrolet', 'Malibu', 2018, 'Front seat has small stain', 'AVAILABLE'),
    (nextval('car_info_id_seq'), 'BMW', 'X5', 2022, 'Recently serviced, excellent condition', 'AT_CAR_WASH'),
