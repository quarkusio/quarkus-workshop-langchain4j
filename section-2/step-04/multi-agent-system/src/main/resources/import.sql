...
VALUES
    ...
    (nextval('car_info_id_seq'), 'Chevrolet', 'Malibu', 2018, 'Front seat has small stain', NULL, 'AT_CAR_WASH'),
    (nextval('car_info_id_seq'), 'BMW', 'X5', 2022, 'Recently serviced, excellent condition', NULL, 'AT_CAR_WASH'),
